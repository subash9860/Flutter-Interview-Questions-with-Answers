...
13.	What are the advantages and disadvantages of Flutter?
		...
		Good Community: Flutter has good community support where the developers can ask the issues and get the result 	
		quickly.
